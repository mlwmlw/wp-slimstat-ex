...
jQuery.fn.daterangepicker = function(settings){
	...
	//defaults
	var options = jQuery.extend({// 082 EDIT: Added SlimStatL10n
		presetRanges: [
			{text: SlimStatL10n.presetRanges_today||'Today', dateStart: 'today', dateEnd: 'today' },
			{text: SlimStatL10n.presetRanges_week||'Last 7 days', dateStart: 'today-7days', dateEnd: 'today' },
			{text: SlimStatL10n.presetRanges_month||'Month to date', dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
			{text: SlimStatL10n.presetRanges_year||'Year to date', dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
			{text: SlimStatL10n.presetRanges_prevmonth||'The previous Month', dateStart: function(){ return Date.parse('1 month ago').moveToFirstDayOfMonth();  }, dateEnd: function(){ return Date.parse('1 month ago').moveToLastDayOfMonth();  } }
		...
		presets: {
			specificDate: SlimStatL10n.specificDate||'Specific Date', 
			allDatesBefore: SlimStatL10n.allDatesBefore||'All Dates Before', 
			allDatesAfter: SlimStatL10n.allDatesAfter||'All Dates After', 
			dateRange: SlimStatL10n.dateRange||'Date Range'
		},
		rangeStartTitle: SlimStatL10n.rangeStartTitle||'Start date',
		rangeEndTitle: SlimStatL10n.rangeEndTitle||'End date',
		nextLinkText: SlimStatL10n.nextLinkText||'Next',
		prevLinkText: SlimStatL10n.prevLinkText||'Prev',
		doneButtonText: SlimStatL10n.doneButtonText||'Done',
